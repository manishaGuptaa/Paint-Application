...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.pen_button = Button(self.paint_tools,padx=6,image=self.pen_logo,borderwidth=2,command=self.pen)
        ...
        self.brush_button = Button(self.paint_tools,image = self.brush_logo,borderwidth=2,command=self.brush) 
        ...
        self.color_button = Button(self.paint_tools,image = self.color_logo,borderwidth=2,command=self.color_choosen)
        ...
        self.eraser_button = Button(self.paint_tools,image = self.eraser_logo,borderwidth=2,command=self.eraser)
